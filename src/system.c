...
void run_command() {
	...
	// Clears all previous text from the screen
		...
		//size_t rngnum = random(0,100);
		//putsln(rngnum);
		putsln("This feature dosen't work, please if you know the solution on how to fix this feature please contact dypiro on discord");
